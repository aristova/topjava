...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    @Test
    void getBetweenReturnMeals() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL + "filter?startDateTime=" +
                "2020-01-31T00:00" + "&endDateTime=" + "2020-01-31T21:00"))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
    ...
    @Test
    void getBetweenReturnEmpty() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL + "filter?startDateTime=" +
                "2020-01-31T00:00" + "&endDateTime=" + "2020-01-31T00:00"))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
